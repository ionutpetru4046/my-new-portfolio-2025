...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                View My Work
              </button>
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                I&apos;m a full-stack developer with over 3 years of experience crafting digital experiences.
                My journey began with a curiosity about how websites work, and it has evolved into a
                passion for building scalable, user-friendly applications that solve real-world problems.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                I specialize in modern web technologies and enjoy working across the entire stack,
                from responsive front-end interfaces to robust back-end systems. When I&apos;m not coding,
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {[
                  ...
                  'AWS', 'Docker', 'Git', 'Tailwind CSS', 'GraphQL', 'REST APIs'
                ].map((skill) => (
                  <div key={skill} className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 p-3 rounded-lg text-center">
            ...
            {[
              {
                ...
                company: "TechCorp",
                content: "Exceptional developer who delivered beyond expectations. The attention to detail and problem-solving skills are outstanding.",
                rating: 5
              },
              {
                name: "Mike Chen",
                role: "CTO",
                company: "StartupXYZ",
                content: "Reliable and skilled full-stack developer. Transformed our platform with modern technologies and improved performance significantly.",
                rating: 5
              },
              {
                name: "Emma Davis",
                ...
                content: "Great collaboration skills and technical expertise. Always willing to go the extra mile to ensure pixel-perfect implementation.",
                rating: 5
              }
            ].map((testimonial) => (
              <div
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  period: "2020 - 2022",
                  description: "Developed and maintained multiple client projects using modern web technologies, collaborated with design teams, and optimized applications for scalability.",
                  achievements: [
                ...
                },
                {
                  ...
                  company: "StartupTech",
                  period: "2019 - 2020",
                  description: "Started my professional journey learning industry best practices, contributing to team projects, and gaining experience with various technologies.",
                  achievements: [
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300">hello@developer.com</div>
                  </div>
                </div>
      ...
      {/* Blog Section */}
      <section id="blog" className="py-20 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            {[
              {
                ...
                excerpt: "Learn how to structure your React applications for scalability and maintainability with modern patterns and best practices.",
                date: "Dec 15, 2024",
                readTime: "5 min read",
                category: "React",
                image: "/api/placeholder/400/250"
              },
              {
                ...
                excerpt: "Exploring emerging technologies and trends that are shaping the future of web development in 2025 and beyond.",
                date: "Dec 10, 2024",
                readTime: "7 min read",
                category: "Technology",
                image: "/api/placeholder/400/250"
