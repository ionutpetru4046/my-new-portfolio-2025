    ...
    <div className="text-center">
      ...
      <div className="mt-8 flex justify-center gap-8 text-center">
        ...
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Technologies Mastered</p>
        </div>
      </div>
      ...
      <div className="mt-12 flex justify-center">
        <svg className="w-6 h-6 animate-bounce text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
